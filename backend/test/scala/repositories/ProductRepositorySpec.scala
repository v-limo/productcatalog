...
//	
//	
//	"Database Product Repository should..  " should {
//		
//		"create a product" in running(application) {
//			val repository = inject[IProductRepository]
//			
//			val newProduct = Product(1L, "Product 1", "Cat 1", "P1", BigDecimal(10), None)
//			
...
//			
//			val product = Product(1L, "Product 1", "Cat 1", "P1", BigDecimal(10), None)
//			
